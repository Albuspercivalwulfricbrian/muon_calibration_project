...
int main(int argc, char** argv)
{
    ...
    //TString source_path = "/home/doc/entanglement/double_GAGG/big_file/";
    // TString source_path = gSystem->GetFromPipe("yad --file-selection --directory")+"/";
    source_path="/home/doc/entanglement/double_GAGG/";
    const Short_t EventType = 1;
    const Int_t left_interaction = EventType%2;
    const Int_t right_interaction = EventType/2;
    TString middle_path = source_path + "MiniDST_total";
    ...
    TString result_path = middle_path + Form("_EvType=%i_analyzed",EventType);
    ...
    Float_t high_intermediate_cut[2] = {400,400};
    Float_t low_intermediate_cut[2] = {1,1};
/////////////////////////////////
////////////////////////////////

    TCutG *cutgent = new TCutG("CUTGENT",11); //for entangled
    cutgent->SetVarX("MiniTree.EdepScat0 ");
    cutgent->SetVarY("MiniTree.EdepDet0");
    cutgent->SetTitle("Graph");
    cutgent->SetFillStyle(1000);
    cutgent->SetPoint(0,182.818,239.299);
    cutgent->SetPoint(1,235.138,220.437);
    cutgent->SetPoint(2,287.459,216.809);
    cutgent->SetPoint(3,311.279,235.309);
    cutgent->SetPoint(4,316.164,254.172);
    cutgent->SetPoint(5,297.842,271.22);
    cutgent->SetPoint(6,252.647,288.269);
    cutgent->SetPoint(7,209.283,288.632);
    cutgent->SetPoint(8,182.003,280.651);
    cutgent->SetPoint(9,172.231,261.064);
    cutgent->SetPoint(10,182.818,239.299);

    TCutG *cutg = new TCutG("CUTG",16); //left decoherence
    cutg->SetVarX("MiniTree.EdepScat0 ");
    cutg->SetVarY("MiniTree.EdepDet0");
    cutg->SetTitle("Graph");
    cutg->SetFillStyle(1000);
    cutg->SetPoint(0,165.479,225.878);
    cutg->SetPoint(1,203.476,195.77);
    cutg->SetPoint(2,249.892,195.408);
    cutg->SetPoint(3,283.571,206.653);
    cutg->SetPoint(4,308.182,222.25);
    cutg->SetPoint(5,308.182,222.25);
    cutg->SetPoint(6,292.422,255.985);
    cutg->SetPoint(7,292.422,255.985);
    cutg->SetPoint(8,249.676,286.455);
    cutg->SetPoint(9,199.59,304.592);
    cutg->SetPoint(10,168.718,304.592);
    cutg->SetPoint(11,168.718,304.592);
    cutg->SetPoint(12,146.265,288.632);
    cutg->SetPoint(13,146.265,288.632);
    cutg->SetPoint(14,152.31,253.446);
    cutg->SetPoint(15,165.479,225.878);
    if (left_interaction == 0 ) {delete cutg; cutg = nullptr; cutg = cutgent;}
    TCutG *cutg1 = new TCutG("CUTG1",15); //right decoherence
    // cutg1->SetVarX("MiniTree.EdepScat1 ");
    // cutg1->SetVarY("MiniTree.EdepDet1");
    // cutg1->SetTitle("Graph");
    // cutg1->SetFillStyle(1000);
    // cutg1->SetPoint(0,148.856,245.828);
    // cutg1->SetPoint(1,183.182,216.809);
    // cutg1->SetPoint(2,183.182,216.809);
    // cutg1->SetPoint(3,224.201,196.133);
    // cutg1->SetPoint(4,275.583,189.967);
    // cutg1->SetPoint(5,303.217,197.221);
    // cutg1->SetPoint(6,346.826,209.192);
    // cutg1->SetPoint(7,352.008,249.093);
    // cutg1->SetPoint(8,284.866,279.563);
    // cutg1->SetPoint(9,218.804,297.337);
    // cutg1->SetPoint(10,158.571,316.2);
    // cutg1->SetPoint(11,112.37,325.268);
    // cutg1->SetPoint(12,112.37,325.268);
    // cutg1->SetPoint(13,140.22,253.809);
    // cutg1->SetPoint(14,148.856,245.828);

    cutg1->SetVarX("MiniTree.EdepScat1 ");
    cutg1->SetVarY("MiniTree.EdepDet1");
    cutg1->SetTitle("Graph");
    cutg1->SetFillStyle(1000);
    cutg1->SetPoint(0,165.479,225.878);
    cutg1->SetPoint(1,203.476,195.77);
    cutg1->SetPoint(2,249.892,195.408);
    cutg1->SetPoint(3,283.571,206.653);
    cutg1->SetPoint(4,308.182,222.25);
    cutg1->SetPoint(5,308.182,222.25);
    cutg1->SetPoint(6,292.422,255.985);
    cutg1->SetPoint(7,292.422,255.985);
    cutg1->SetPoint(8,249.676,286.455);
    cutg1->SetPoint(9,199.59,304.592);
    cutg1->SetPoint(10,168.718,304.592);
    cutg1->SetPoint(11,168.718,304.592);
    cutg1->SetPoint(12,146.265,288.632);
    cutg1->SetPoint(13,146.265,288.632);
    cutg1->SetPoint(14,152.31,253.446);
    cutg1->SetPoint(15,165.479,225.878);
    if (right_interaction == 0 ) {delete cutg1; cutg1 = nullptr; cutg1 = cutgent;}

////////////////////////////////
//////////////Setting TCUTG boarders
    TCanvas *canv_0 = new TCanvas("canv_0,canv_0");
    canv_0->cd();
    TH2F *h2 = new TH2F("h2","h2", 75,0,500,75,0,500); //h2->GetZaxis()->SetRangeUser(5,70);
    TH2F *h3 = new TH2F("h3","h3", 75,0,500,75,0,500); //h2->GetZaxis()->SetRangeUser(5,70);
    ...
    // MiniDST_tree->Draw("MiniTree.EdepIntermediate0:MiniTree.EdepDet0 >> h2","TimeTree.TimeIntermediate0-TimeScat0 < 75 && TimeTree.TimeIntermediate0-TimeScat0 > 50", "colz");
        MiniDST_tree->Draw("MiniTree.EdepDet0:MiniTree.EdepScat0 >> h2",Form("EventType == %i",EventType), "colz");
    cutg->Draw("same");
    canv_0->SaveAs(result_path+".pdf(",".pdf");
    canv_0->Write();

    TCanvas *canv_1 = new TCanvas("canv_1,canv_1");
    canv_1->cd();
    MiniDST_tree->Draw("MiniTree.EdepDet1:MiniTree.EdepScat1 >> h2",Form("EventType == %i",EventType), "colz");
    cutg1->Draw("same");
    ...
    for (int interaction = 0; interaction <=1; interaction++)
    {
        ...
        double_gauss_fit(det0, low_det0_cut[interaction], high_det0_cut[interaction],1.5,1.5);
        det0->Write();
        new_canv->SaveAs(result_path+".pdf(",".pdf");
        new_canv->Clear();

        MiniDST_tree->Draw("MiniTree.EdepDet1 >> det1", Form("MiniTree.EventType == %i", 2*interaction));
        double_gauss_fit(det1, low_det1_cut[interaction], high_det1_cut[interaction],1.5,1.5);
        det1->Write();
        new_canv->SaveAs(result_path+".pdf(",".pdf");
        new_canv->Clear();
        ...
        double_gauss_fit(scat1, low_scat1_cut[interaction], high_scat1_cut[interaction],1.5,1.5);
        scat1->Write();
        new_canv->SaveAs(result_path+".pdf(",".pdf");
        new_canv->Clear();
        ...
        double_gauss_fit(scat0, low_scat0_cut[interaction], high_scat0_cut[interaction],1.5,1.5);
        scat0->Write();
        new_canv->SaveAs(result_path+".pdf(",".pdf");
        new_canv->Clear();
...
//total energy cuts
        ...
        && short_tree->EdepScat0 + short_tree->EdepDet0 + short_tree -> EdepIntermediate0 > 400
        && short_tree->EdepScat0 + short_tree->EdepDet0 + short_tree -> EdepIntermediate0 < 600
        && short_tree->EdepScat1 + short_tree->EdepDet1 + short_tree -> EdepIntermediate1 > 400
        ...
        && (
        (
            short_tree->EventType == 3 && 
            short_tree->EdepIntermediate0 > low_intermediate_cut[0]
            && short_tree->EdepIntermediate0 < high_intermediate_cut[0]
            &&
            short_tree->EdepIntermediate1 > low_intermediate_cut[1]
            && short_tree->EdepIntermediate1 < high_intermediate_cut[1]
        ) 
        || 
        (
            short_tree->EventType == 2 &&
            short_tree->EdepIntermediate1 > low_intermediate_cut[1]
            && short_tree->EdepIntermediate1 < high_intermediate_cut[1]
        ) 
        ||
        (
            short_tree->EventType == 1 
            && short_tree->EdepIntermediate0 > low_intermediate_cut[0]
            && short_tree->EdepIntermediate0 < high_intermediate_cut[0]
        ) 
        ||
        ...
        && short_tree->EdepIntermediate0 < 70
        && short_tree->EdepIntermediate0 > 50
        // && short_tree->EdepScat0 > 220  
        // && short_tree->EdepScat0 < 280  
        ...
        && time_tree->TimeDet0-time_tree->TimeScat0 > 170
        && time_tree->TimeDet1-time_tree->TimeScat1 > 170
        && time_tree->TimeDet0-time_tree->TimeScat0 < 260
        && time_tree->TimeDet1-time_tree->TimeScat1 < 260      

        && ((time_tree->TimeIntermediate0 - time_tree->TimeScat0 < 320
        && time_tree->TimeIntermediate0 - time_tree->TimeScat0 > 240
        // && ((time_tree->TimeIntermediate0 - time_tree->TimeScat0 < 80
        // && time_tree->TimeIntermediate0 - time_tree->TimeScat0 > 40
        && (short_tree->EventType == 1 || short_tree->EventType == 3)) 
        ||
        (time_tree->TimeIntermediate1 - time_tree->TimeScat1 < 320
        && time_tree->TimeIntermediate1 - time_tree->TimeScat1 > 220
    ...
    for (Int_t channel_number = 0; channel_number < 16; channel_number++)
    {
        for(Int_t channel_number_2 = 16; channel_number_2 < 32; channel_number_2++)
        {
            ...
            //////some shit
            // Int_t i = CHSH_class::true_number(channel_number);
            // Int_t j = CHSH_class::true_number(channel_number_2);
            // total_events_for_angle_diff[angle]+=(float)pow((NumEvents[i][i]+NumEvents[j][j])*(NumEvents[i][i]+NumEvents[j][j])+(NumEvents[i][j]-NumEvents[j][i])*(NumEvents[i][j]-NumEvents[j][i]),0.5)/2;
...
///////////////////////////////////////
    ...
    TCanvas *canvas_CHSH = new TCanvas ( "S", "S");
...
// #if DrawAllAngles 
    ...
    // canvas_CHSH->cd(2);
    graph_like_ivashkin_wants_it(gr_CHSH_all,"azimuthal angle #phi (degrees)","S-function","Average E",1);
    gr_CHSH_all->Draw("AP");
    canvas_CHSH->Write();   
// #endif
    ...
    graph_like_ivashkin_wants_it(global_gr_CHSH,"azimuthal angle #Delta#phi (degrees)","S", "Sum N",1);
   ...
   ///////////////////////Draw Asymmetry
    ...
    TCanvas *canvas = new TCanvas ( "R", "R");
    canvas->cd();
